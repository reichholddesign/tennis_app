...
const PlayerForm = ({ player, mutationFunction }) => {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const watchGender = watch("gender", player?.gender || false);
        ...
        {watchGender === "Other" && (
          <>
            <FormInput
              ...
              initialVal={player?.specified_gender}
              register={register}
              errors={errors}
              validation={{}}
              type={"text"}
